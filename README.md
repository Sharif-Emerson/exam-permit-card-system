...
### 3.7.2 Student Portal â€” Permit and Eligibility
...
### 3.7.3 Student Portal â€” Profile and Support
...
### 3.7.4 Administrator Portal â€” Student Management
...
### 3.7.5 Administrator Portal â€” Financial Management
...
### 3.7.6 Administrator Portal â€” Audit and Reporting

FR-37: The system shall record every administrator-initiated financial action â€” including payment updates, profile edits, and bulk imports â€” to an activity log that captures the administrator identity, affected student, action type, and timestamp.
...
### 3.7.7 Administrator Portal â€” Access Control
...
NFR-02: The system shall return API responses for read operations â€” such as fetching a student profile or listing student records â€” within two seconds under a concurrent load of at least fifty active users.
...
NFR-13: All interactive elements â€” including buttons, form fields, and navigation items â€” shall meet a minimum touch target size of 44 Ã— 44 pixels to support mobile and touch-based interaction.
...
NFR-15: The system shall provide visual feedback â€” such as a loading indicator or disabled state â€” whenever an asynchronous operation is in progress, preventing duplicate submissions.
...
NFR-17: Key screens â€” including the login page, student dashboard, and permit card â€” shall pass automated accessibility checks for colour contrast, keyboard navigability, and ARIA labelling in conformance with WCAG 2.1 Level AA.
...
NFR-25: Application configuration â€” including API base URL, session duration, CORS origins, and database path â€” shall be provided through environment variables rather than hard-coded values, enabling the system to be reconfigured for different deployment environments without modifying source code.
...
NFR-30: The system shall support a same-origin deployment model â€” where the frontend and backend are served from the same domain â€” to eliminate cross-origin browser restrictions in production without requiring CORS configuration.
