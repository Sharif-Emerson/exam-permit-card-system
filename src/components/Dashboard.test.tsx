...
describe('Dashboard', () => {
  ...
  it('allows skipping first-login security setup', async () => {
    window.localStorage.clear()
    ...
    await waitFor(() => {
      expect(screen.queryByText(/security setup required/i)).toBeNull()
    })
    expect(await screen.findByText(/you skipped security setup for now/i)).toBeTruthy()
  }, 10000)
